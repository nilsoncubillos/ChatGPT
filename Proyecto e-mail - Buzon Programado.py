...
# Definir la dirección del remitente
remitente = "SOX.ITGC@tigo.com"

# Definir la fecha y hora de envío
fecha_envio = datetime.datetime(2024, 4, 13, 17, 0)  # 13 de abril de 2024 a las 5 p.m.
...
for row in sheet.iter_rows(min_row=2, values_only=True):
    ...
    # Establecer el remitente del correo electrónico
    ...
    # Programar el envío del correo electrónico
    mail.DeferredDeliveryTime = fecha_envio

    # Enviar el correo electrónico de inmediato
    mail.Send()

    print("Correo programado para enviar a", correo)
